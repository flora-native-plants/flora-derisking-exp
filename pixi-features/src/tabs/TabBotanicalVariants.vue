...
function rebuild() {
  ...
  // Fitted to realtex swatches (eyedropper): A = a clean leaf green (mid wash #4a8746 / light
  // #689f61 — G-dominant, R≈B), B = a grayed warm olive-brown (bloom #776e54, not saturated orange).
